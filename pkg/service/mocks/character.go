...
func (m *MockCharacterService) CreateCharacter(ctx context.Context, ownerId, name, gender, realm, profession string, dimensionId *uuid.UUID) (*character.Character, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateCharacter", ctx, ownerId, name, gender, realm, profession, dimensionId)
	ret0, _ := ret[0].(*character.Character)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockCharacterServiceMockRecorder) CreateCharacter(ctx, ownerId, name, gender, realm, profession, dimensionId any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCharacter", reflect.TypeOf((*MockCharacterService)(nil).CreateCharacter), ctx, ownerId, name, gender, realm, profession, dimensionId)
}
