...
// Source: /home/wil/dev/sro/character-service/pkg/repository/character.go
//
// Generated by this command:
//
//	mockgen -package=mocks -source=/home/wil/dev/sro/character-service/pkg/repository/character.go -destination=/home/wil/dev/sro/character-service/pkg/mocks/character_mock.go
//
...
func (m *MockCharacterRepository) DeleteCharacter(ctx context.Context, characterId string) (*character.Character, error) {
	m.ctrl.T.Helper()
...
func (m *MockCharacterRepository) GetCharacterById(ctx context.Context, characterId string) (*character.Character, error) {
	m.ctrl.T.Helper()
