...
// Source: /home/wil/dev/sro/character-service/pkg/pb/inventory_grpc.pb.go
//
// Generated by this command:
//
//	mockgen -source=/home/wil/dev/sro/character-service/pkg/pb/inventory_grpc.pb.go -destination=/home/wil/dev/sro/character-service/pkg/pb/mocks/inventory_grpc.pb.go
//
...
func (m *MockInventoryServiceClient) GetInventory(ctx context.Context, in *pb.GetInventoryRequest, opts ...grpc.CallOption) (*pb.GetInventoryResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
	...
	ret0, _ := ret[0].(*pb.GetInventoryResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// GetInventory mocks base method.
func (m *MockInventoryServiceServer) GetInventory(arg0 context.Context, arg1 *pb.GetInventoryRequest) (*pb.GetInventoryResponse, error) {
	m.ctrl.T.Helper()
